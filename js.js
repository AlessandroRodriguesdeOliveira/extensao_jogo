...
async function salvarUsuario(e){
    ...
    try{
        ...
        texto.innerHTML = 'Obrigado por jogar! <br> Agora a explicação de cada pergunta! <br> <br> A primeira sobre a árvore pertencer ao mesmo solo em que ela foi arrancada: é sobre a <u><strong>causa indígena</strong></u>, eles devem ser reconhecidos como pertencentes ao Brasil, mesmo depois de toda a exploração colonial sobre suas vidas e cultura. <br><br> A segunda sobre a luz ser verdadeira mesmo sem iluminar a todos: é sobre os <u><strong>Direitos Humanos</strong></u>, eles não podem ser direitos garantidos universalmente enquanto não assiste a todos do planeta; devemos ter como primeiro direito a garantia de termos direitos. <br> <br> A terceira sobre duas formas de formato iguais e origens diferentes, se são iguais: é sobre a <u><strong>causa afrodescendentes</strong></u>, em comparação com os demais, eles são iguais, pois, a sua única diferença é a sua origem. <br> <br> A quarta sobre cuidar do ente querido, é sobre a <u><strong>mãe natureza</strong></u>,você não poderá salvá-la apenas cuidando dela sem realizar atos (ter ação) para isso. <br> <br> A quinta sobre o seu pomar que, também é usados por seus vizinhos, se pertence a eles: é sobre a <u><strong>cultura</strong></u>, as outras pessoas que compartilham da sua cultura também são merecedoras de fazer parte do seu coletivo e de protegê-la juntamente com você. <br> <br> A sexta sobre jogar fora algum dos três objetos que você possui: é sobre o <u><strong>valor potencial da nossa flora e fauna</strong></u>, pois, há espécies que conhecemos e usamos, as que conhecemos e não usamos, e as desconhecidas, se jogássemos alguma delas fora, iríamos perder itens valiosos para nosso presente e futuro. <br> <br> A sétima sobre a balança, se algum dos dois personagens sobrevive caso um dos dois morra: é sobre <u><strong>você e o meio ambiente</strong></u>, você não sobrevive sem a natureza e nem ela sem a sua ajuda/manutenção. <br> <br> A oitava sobre a porta aberta com sangue, se ela ainda vai ficar aberta sem o auxílio de ninguém: é sobre a <u><strong>garantia dos nossos direitos</strong></u>, mesmo depois de lutarmos para consegui-la, ela não irá continuar em vigor sem sua reivindicação diariamente.'
    }
    catch(erro){
        console.error(erro);
